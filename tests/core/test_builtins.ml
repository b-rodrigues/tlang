let run_tests _pass_count _fail_count _eval_string _eval_string_env test =
  ...
  test "path_basename wrong type" {|path_basename(42)|} {|Error(TypeError: "Expected String path, got Int")|};
  ...
  test "path_dirname wrong type" {|path_dirname(42)|} {|Error(TypeError: "Expected String path, got Int")|};
  ...
  test "path_ext wrong type" {|path_ext(42)|} {|Error(TypeError: "Expected String path, got Int")|};
  ...
  test "path_stem wrong type" {|path_stem(42)|} {|Error(TypeError: "Expected String path, got Int")|};
  ...
  test "path_abs wrong type" {|path_abs(42)|} {|Error(TypeError: "Expected String path, got Int")|};
  print_newline ();
