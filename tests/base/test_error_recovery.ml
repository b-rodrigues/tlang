let run_tests pass_count fail_count _eval_string eval_string_env test =
  ...
  test "name error in arithmetic propagates" "undefined_var + 1" {|Error(NameError: "Name `undefined_var` is not defined.")|};

  test "calling error value as function" "(1/0)()" {|Error(DivisionByZero: "Division by zero.")|};
