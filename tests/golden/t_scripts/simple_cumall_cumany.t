...
df2 = mutate(df, $high_score = $score > 85)
df3 = mutate(df2, $cumall_high = cumall($high_score))
result = mutate(df3, $cumany_high = cumany($high_score))
write_csv(result, "tests/golden/t_outputs/simple_cumall_cumany.csv")
print("success cumall/cumany complete")
