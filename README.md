...
[![Status: Beta](https://img.shields.io/badge/Status-Beta%200.54.2%20%22Le%20Tournoi%22-blue.svg)](https://tstats-project.org/changelog.html)
...
**Beta 0.54.2 "Le Tournoi"** — The core syntax and functional semantics are stable. T is not just a DSL for reproducible, polyglot data science, but it also provides extensive native support for standard data manipulation verbs:
