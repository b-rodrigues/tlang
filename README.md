...
[![Status: Beta](https://img.shields.io/badge/Status-Beta%200.52.1%20%22Sangoku%22-blue.svg)](https://tstats-project.org)
...
**Alpha 0.52.1** — The core syntax and functional semantics are stable. T is now a **reproducibility- and pipeline-first** language, with extensive native support for standard data manipulation verbs:
