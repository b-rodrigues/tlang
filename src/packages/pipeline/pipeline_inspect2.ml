...
--# - Deserializer/format coherence across dependency edges (`text` is treated
--#   as format-agnostic raw bytes: shell/`capture = "stdout"` nodes may consume
--#   any format and typed nodes may read a shell node's raw output)
