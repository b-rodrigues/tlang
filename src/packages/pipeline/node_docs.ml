...
--# enable cross-runtime evaluation. `runtime = Quarto` can be used to render a `.qmd`
--# document via the Quarto CLI.
--#
--# @name node
...
--# @param args :: Dict (Optional) Runtime/tool arguments. For Quarto, use this to pass CLI arguments such as `subcommand`, `path`, and additional options.
