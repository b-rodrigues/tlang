...
--# Supports models generated by lm() or imported via PMML and ONNX.
--# Also supports PMML decision trees, random forests, and XGBoost/LightGBM.
--#
--# For ONNX models, features are automatically resolved via model metadata
--# or by matching numeric columns in order.
--#
--# @name predict
--# @param data :: DataFrame The new data used for prediction.
--# @param model :: Model The linear / ensemble / ONNX model object.
