    ...
    if runtime = "Quarto" || runtime = "sh" || runtime = "fetchurl" then
      ...
      let get_load_stmt dep_name =
        ...
        let read_fns = match runtime with
          | "R" -> [ "json", "r_read_json"; "arrow", "r_read_arrow"; "parquet", "r_read_parquet"; "pmml", "r_read_pmml"; "onnx", "r_read_onnx"; "csv", "r_read_csv"; ]
          | "Python" -> [ "json", "py_read_json"; "arrow", "py_read_arrow"; "parquet", "py_read_parquet"; "pmml", "py_read_pmml"; "onnx", "py_read_onnx"; "csv", "py_read_csv"; ]
          | "Julia" -> [ "json", "jl_read_json"; "arrow", "jl_read_arrow"; "parquet", "jl_read_parquet"; "pmml", "jl_read_pmml"; "onnx", "jl_read_onnx"; "csv", "jl_read_csv"; ]
          | _ -> [ "json", "t_read_json"; "arrow", "read_arrow"; "parquet", "read_parquet"; "pmml", "t_read_pmml"; "onnx", "t_read_onnx"; "csv", "read_csv"; ]
        in
...
EOF|} k (Nix_utils.nix_escape_indented_code expr_str)
  ...
  let ser_call =
    let write_fns = match runtime with
      | "R" -> [ "json", "r_write_json"; "arrow", "r_write_arrow"; "parquet", "r_write_parquet"; "pmml", "r_write_pmml"; "onnx", "r_write_onnx"; "csv", "r_write_csv"; ]
      | "Python" -> [ "json", "py_write_json"; "arrow", "py_write_arrow"; "parquet", "py_write_parquet"; "pmml", "py_write_pmml"; "onnx", "py_write_onnx"; "csv", "py_write_csv"; ]
      | "Julia" -> [ "json", "jl_write_json"; "arrow", "jl_write_arrow"; "parquet", "jl_write_parquet"; "pmml", "jl_write_pmml"; "onnx", "jl_write_onnx"; "csv", "jl_write_csv"; ]
      | _ -> [ "json", "t_write_json"; "arrow", "write_arrow"; "parquet", "write_parquet"; "pmml", "t_write_pmml"; "onnx", "t_write_onnx"; "csv", "write_csv"; "text", "write_text"; ]
    in
