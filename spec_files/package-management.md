...
```nix
{
  ...
  inputs = {
    ...
    t-lang.url = "github:b-rodrigues/tlang/v0.51.0";
    # Package dependencies as flake inputs
    stats.url = "github:t-lang/stats/v0.51.0";
...
5. **T package git tags**: T packages are referenced from their git repositories using release tags (e.g., `v0.51.0`), ensuring exact reproducibility.
...
*Part of the `stats` package. Added in v0.51.0*
```
